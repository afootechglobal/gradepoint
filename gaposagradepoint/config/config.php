...
$website_url="http://localhost/gaposagradepoint.com";
...
//// For all API's /////////
	...
	var website_url="http://localhost/gaposagradepoint.com";
	...
	var api="http://localhost/gradepoint_api/";
	...
	var add_or_update_faculty_api=api+"?action=add_or_update_faculty_api&access_key=<?php echo $access_key?>&role=<?php echo $role_id?>"; //// fetch staff api
	var fetch_faculty_api=api+"?action=fetch_faculty_api&access_key=<?php echo $access_key?>&role=<?php echo $role_id?>"; //// fetch staff api
	var fetch_all_faculty_api=api+"?action=fetch_all_faculty_api&access_key=<?php echo $access_key?>&role=<?php echo $role_id?>"; //// fetch staff api
	

	var add_or_update_department_api=api+"?action=add_or_update_department_api&access_key=<?php echo $access_key?>&role=<?php echo $role_id?>"; //// fetch staff api
	var fetch_department_api=api+"?action=fetch_department_api&access_key=<?php echo $access_key?>&role=<?php echo $role_id?>"; //// fetch staff api
