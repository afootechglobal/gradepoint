        ...
        <div class="left-div">
            <div class="top-div">
                <div class="form-div">
                    ...
                    <a href="<?php echo $website_url?>/admin"><div class="logo-div"><img src="all-images/images/icon.png" alt="Logo"></div></a>
            ...
            <div class="footer-div">
                <div class="div-in">Developed By: <a href="#" title="AfooTECH Global" target="_blank"><u><strong>Emmanuel</strong></u></a></div>
            </div>
        </div>
        ...
        <div class="right-div">
            <div class="cover-div animated zoomIn">
                <div class="div-in">
                    ...
                    <P>GAPOSA GRADEPOINT ADMIN PORTAL</P>
                </div>
            </div>
        </div>
    </div>
